...
| `logos-doctrine-genealogy` | Planned doctrine-lineage, theologian, tradition, and profile-comparison plane after D7 registration gates are satisfied. | Planned; use [`governance/ADDING_NEW_LOGOS_REPOS.md`](governance/ADDING_NEW_LOGOS_REPOS.md) before creation. | Exist before registration, rewrite Scripture, own commentary corpora, mint verbs or entity IDs, or collapse contested doctrine. |
