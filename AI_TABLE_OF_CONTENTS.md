...
- [`docs/roadmap/fable-kernels/README.md`](docs/roadmap/fable-kernels/README.md) - Fable architecture kernels and recorded owner decisions D1-D10 for doctrine-genealogy, schema mirrors, and cross-repo evidence work
