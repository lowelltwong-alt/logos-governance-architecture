...
| DAD-FABLE-026 | Keep the learning loop thin, indexed, and admission-tested. | A lesson system can become noisy enough that agents stop reading it. | Kernel L; D11-A | Planned LLOS standard with admission tests, P0 budget discipline, route/category loading, and sunset review. | Learning systems for law firms should rank lessons by trigger and criticality, require admission criteria, and sunset low-utility lessons. |
